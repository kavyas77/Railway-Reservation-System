            ...
            switch (choice) {
                ...
                case 4:
                    if (bookedPassengers.isEmpty()) {
                        ...
                        System.out.println("\n--- Passenger Chart ---");
                        System.out.printf("%-15s %-5s %-15s %-10s%n", "Name", "Age", "Train", "Seat No.");
                        for (Person p : bookedPassengers) {
                            System.out.printf("%-15s %-5d %-15s %-10d%n",
                                    p.getName(), p.getAge(), p.getTrainName(), p.getSeatNumber());
                        }
                    }
                    break;
